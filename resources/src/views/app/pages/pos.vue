                            ...
                            >
                                ...
                                >
                                    ...
                                    <div class="flex-grow-1 d-bock">
                                        ...
                                        >
                                            <div
                                                class="w-40 w-sm-100 item-title"
                                            >
                                                {{ product.name }}
                                            </div>
                                            <p
                                                class="text-muted text-small w-15 w-sm-100 mb-2"
                                            >
                                                {{ product.code }}
                                            </p>
                    ...
                    <div id="invoice-POS">
                        <div style="max-width: 400px; margin: 0px auto">
                            ...
                            <div id="legalcopy" class="ml-2">
                                ...
                                <div
                                    id="bar"
                                    v-show="pos_settings.show_barcode"
                                >
                                    <barcode
                                        class="barcode"
